...
public class WifiTest {
    ...
    @Test public void connectToNetwork() {
        byte[] waitingForBytes = Bytes.bytesFromHex("005902030004484f4d450400010305000A5a57337641524e554265");
        byte[] commandBytes = null;

        try {
            commandBytes = new ConnectToNetwork("HOME", NetworkSecurity.WPA2_PERSONAL, "ZW3vARNUBe").getBytes();
