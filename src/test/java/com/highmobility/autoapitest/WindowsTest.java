...
public class WindowsTest {
    ...
    @Test public void control() {
        ...
        windowsStates[0] = new WindowPosition(WindowLocation.FRONT_LEFT, WindowPosition
                .Position.OPEN);
        windowsStates[1] = new WindowPosition(WindowLocation.FRONT_RIGHT, WindowPosition
                .Position.OPEN);
