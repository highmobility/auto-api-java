...
public class NotificationsState extends Command {
    ...
    /**
     * @return Text for the notification, bytes in UTF8
     */
    ...
    public static final class Builder extends Command.Builder {
        ...
        /**
         * @param text Text for the notification, bytes in UTF8
         * @return The builder
         */
         ...
         * @return The builder
         */
        public Builder setActivatedAction(PropertyInteger activatedAction) {
            this.activatedAction = new PropertyInteger(0x03, false, 1, activatedAction);
            addProperty(activatedAction);
            return this;
        }
