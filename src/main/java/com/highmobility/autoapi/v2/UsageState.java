...
import com.highmobility.autoapi.v2.value.DrivingModeActivationPeriod;
import com.highmobility.autoapi.v2.value.DrivingModeEnergyConsumption;
import java.util.Calendar;import java.util.Calendar;
import java.util.ArrayList;
import java.util.List;

public class UsageState extends Command {
    ...
    /**
     * @return Average fuel consumption for current trip in liters/100km per IEEE 754 formatting
     */
    ...
    /**
     * @return Current fuel consumption in liters/100km per IEEE 754 formatting
     */
    public Property<Float> getCurrentFuelConsumption() {
        return currentFuelConsumption;
    }

    UsageState(byte[] bytes) {
        super(bytes);
    ...
    public static final class Builder extends Command.Builder {
         ...
         * @return The builder
         */
        public Builder setAverageWeeklyDistance(PropertyInteger averageWeeklyDistance) {
            this.averageWeeklyDistance = new PropertyInteger(0x01, false, 2, averageWeeklyDistance);
            addProperty(averageWeeklyDistance);
            return this;
        }
         ...
         * @return The builder
         */
        public Builder setAverageWeeklyDistanceLongRun(PropertyInteger averageWeeklyDistanceLongRun) {
            this.averageWeeklyDistanceLongRun = new PropertyInteger(0x02, false, 2, averageWeeklyDistanceLongRun);
            addProperty(averageWeeklyDistanceLongRun);
            return this;
        }
        ...
        public Builder setAccelerationEvaluation(Property<Double> accelerationEvaluation) {
            ...
            addProperty(accelerationEvaluation);
            return this;
        }
        ...
        public Builder setDrivingStyleEvaluation(Property<Double> drivingStyleEvaluation) {
            ...
            addProperty(drivingStyleEvaluation);
            return this;
        }
        ...
        public Builder setLastTripEnergyConsumption(Property<Float> lastTripEnergyConsumption) {
            ...
            addProperty(lastTripEnergyConsumption);
            return this;
        }
        ...
        public Builder setLastTripFuelConsumption(Property<Float> lastTripFuelConsumption) {
            ...
            addProperty(lastTripFuelConsumption);
            return this;
        }
         ...
         * @return The builder
         */
        public Builder setMileageAfterLastTrip(PropertyInteger mileageAfterLastTrip) {
            this.mileageAfterLastTrip = new PropertyInteger(0x09, false, 4, mileageAfterLastTrip);
            addProperty(mileageAfterLastTrip);
            return this;
        }
        ...
        public Builder setLastTripElectricPortion(Property<Double> lastTripElectricPortion) {
            ...
            addProperty(lastTripElectricPortion);
            return this;
        }
        ...
        public Builder setLastTripAverageEnergyRecuperation(Property<Float> lastTripAverageEnergyRecuperation) {
            ...
            addProperty(lastTripAverageEnergyRecuperation);
            return this;
        }
        ...
        public Builder setLastTripBatteryRemaining(Property<Double> lastTripBatteryRemaining) {
            ...
            addProperty(lastTripBatteryRemaining);
            return this;
        }
        ...
        public Builder setLastTripDate(Property<Calendar> lastTripDate) {
            ...
            addProperty(lastTripDate);
            return this;
        }
        
        /**
         * @param averageFuelConsumption Average fuel consumption for current trip in liters/100km per IEEE 754 formatting
         * @return The builder
         */
        public Builder setAverageFuelConsumption(Property<Float> averageFuelConsumption) {
            ...
            addProperty(averageFuelConsumption);
            return this;
        }
        
        /**
         * @param currentFuelConsumption Current fuel consumption in liters/100km per IEEE 754 formatting
         * @return The builder
         */
        public Builder setCurrentFuelConsumption(Property<Float> currentFuelConsumption) {
            ...
            addProperty(currentFuelConsumption);
            return this;
        }
    }
}