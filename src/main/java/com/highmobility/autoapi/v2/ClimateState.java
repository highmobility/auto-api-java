...
public class ClimateState extends Command {
    ...
    /**
     * @return The inside temperature in celsius per IEEE 754 formatting
     */
    ...
    /**
     * @return The outside temperature in celsius per IEEE 754 formatting
     */
    ...
    /**
     * @return The driver temperature setting in celsius per IEEE 754 formatting
     */
    ...
    /**
     * @return The passenger temperature setting in celsius per IEEE 754 formatting
     */
    ...
    /**
     * @return The defrosting temperature setting in celsius per IEEE 754 formatting
     */
    ...
    /**
     * @return The rear temperature in celsius per IEEE 754 formatting
     */
    ...
    public static final class Builder extends Command.Builder {
        ...
        /**
         * @param insideTemperature The inside temperature in celsius per IEEE 754 formatting
         * @return The builder
         */
        ...
        /**
         * @param outsideTemperature The outside temperature in celsius per IEEE 754 formatting
         * @return The builder
         */
        ...
        /**
         * @param driverTemperatureSetting The driver temperature setting in celsius per IEEE 754 formatting
         * @return The builder
         */
        ...
        /**
         * @param passengerTemperatureSetting The passenger temperature setting in celsius per IEEE 754 formatting
         * @return The builder
         */
        ...
        public Builder setIonisingState(Property<ActiveState> ionisingState) {
            ...
            addProperty(ionisingState);
            return this;
        }
        
        /**
         * @param defrostingTemperatureSetting The defrosting temperature setting in celsius per IEEE 754 formatting
         * @return The builder
         */
        public Builder setDefrostingTemperatureSetting(Property<Float> defrostingTemperatureSetting) {
            ...
            addProperty(defrostingTemperatureSetting);
            return this;
        }
        ...
        /**
         * @param rearTemperatureSetting The rear temperature in celsius per IEEE 754 formatting
         * @return The builder
         */
