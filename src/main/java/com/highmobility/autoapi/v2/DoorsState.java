...
import com.highmobility.autoapi.v2.value.DoorPosition;
import com.highmobility.autoapi.v2.value.LockState;
import java.util.ArrayList;
import java.util.List;

public class DoorsState extends Command {
