...
public class HonkAndFlash extends CommandWithProperties {
    ...
    private IntegerProperty lightFlashCount = new IntegerProperty(IDENTIFIER_COUNT,
            false);
    private IntegerProperty seconds = new IntegerProperty(IDENTIFIER_SECONDS, false);
    ...
    public HonkAndFlash(@Nullable Integer seconds, @Nullable Integer lightFlashCount) {
        ...
        if (seconds != null) {
            this.seconds.update(false, 1, seconds);
            properties.add(this.seconds);
        }

        if (lightFlashCount != null) {
            this.lightFlashCount.update(false, 1, lightFlashCount);
