...
import static com.highmobility.autoapi.Command.Identifier.FAILURE;
import static com.highmobility.autoapi.incoming.TrunkState.LockState.UNLOCKED;
import static com.highmobility.autoapi.incoming.TrunkState.Position.CLOSED;
...
public class Command {
    ...
    public enum FailureMessage implements Type {
        ...
        static FailureMessage fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.FAILURE.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
        ...
        public byte[] getIdentifierAndType() {
            return Bytes.concatBytes(getIdentifier().getIdentifier(), getType());
        }
    }
    ...
    public enum Capabilities implements Type {
        ...
        public static byte[] getCapability(Identifier identifier) {
            return Bytes.concatBytes(GET_CAPABILITY.getIdentifierAndType(), identifier.getIdentifier());
        }

        static Capabilities fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.CAPABILITIES.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum VehicleStatus implements Type {
        ...
        static VehicleStatus fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.VEHICLE_STATUS.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum DoorLocks implements Type {
        ...
        static DoorLocks fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.DOOR_LOCKS.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum TrunkAccess implements Type {
        ...
        static TrunkAccess fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.TRUNK_ACCESS.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum WakeUp implements Type {
        ...
        static WakeUp fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.WAKE_UP.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Charging implements Type {
        ...
        public static byte[] setChargeLimit(float limit) throws IllegalArgumentException {
            ...
            return Bytes.concatBytes(SET_CHARGE_LIMIT.getIdentifierAndType(), limitByte);
        }

        static Charging fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.CHARGING.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Climate implements Type {
        ...
        public static byte[] setClimateProfile(AutoHvacState[] states,
            ...
            Bytes.setBytes(command, SET_CLIMATE_PROFILE.getIdentifierAndType(), 0);
            ...
            Bytes.setBytes(command, driverTempByte, 18);

            byte[] passengerTempByte = ByteBuffer.allocate(4).putFloat(passengerTemperature).array();
            Bytes.setBytes(command, passengerTempByte, 22);
        ...
        static Climate fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.CLIMATE.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum RooftopControl implements Type {
        ...
        static RooftopControl fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.ROOFTOP.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum HonkFlash implements Type {
        ...
        public static byte[] honkFlash(int seconds, int lightFlashCount) throws IllegalArgumentException {
            ...
            return Bytes.concatBytes(HONK_FLASH.getIdentifierAndType(), payLoad);
        }
        ...
        static HonkFlash fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.HONK_FLASH.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum RemoteControl implements Type {
        ...
        public static byte[] controlCommand(int speed, int angle) {
            ...
            return Bytes.concatBytes(CONTROL_COMMAND.getIdentifierAndType(), new byte[] {(byte)speed, msb, lsb});
        }

        static RemoteControl fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.REMOTE_CONTROL.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum ValetMode implements Type {
        ...
        static ValetMode fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.VALET_MODE.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum HeartRate implements Type {
        ...
        public static byte[] sendHeartRate(int heartRate) {
            return Bytes.concatBytes(SEND_HEART_RATE.getIdentifierAndType(), (byte)heartRate);
        }

        static HeartRate fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.HEART_RATE.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum VehicleLocation implements Type {
        ...
        static VehicleLocation fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.VEHICLE_LOCATION.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum VehicleTime implements Type {
        ...
        static VehicleTime fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.VEHICLE_TIME.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum NaviDestination implements Type {
        ...
        static NaviDestination fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.NAVI_DESTINATION.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum DeliveredParcels implements Type {
        ...
        static DeliveredParcels fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.DELIVERED_PARCELS.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Diagnostics implements Type {
        ...
        static Diagnostics fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.DIAGNOSTICS.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Maintenance implements Type {
        ...
        static Maintenance fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.MAINTENANCE.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Engine implements Type {
        ...
        static Engine fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.ENGINE.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Lights implements Type {
        ...
        public static byte[] controlLights(LightsState.FrontExteriorLightState frontExteriorLightState,
            ...
            command = Bytes.concatBytes(command, colorBytes);

            return command;
        }

        static Lights fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.LIGHTS.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Windows implements Type {
        ...
        public static byte[] openCloseWindows(WindowState[] windowStates) {
            ...
            command = Bytes.concatBytes(command, (byte) windowStates.length);

            for (int i = 0; i < windowStates.length; i++) {
                command = Bytes.concatBytes(command, windowStates[i].getBytes());
            }
        ...
        static Windows fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.WINDOWS.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Windscreen implements Type {
        ...
        public static byte[] setWindscreenDamage(WindscreenState.WindscreenDamage damage,
            ...
            command = Bytes.concatBytes(command, damage.getByte());
            command = Bytes.concatBytes(command, position.getPositionByte());
            command = Bytes.concatBytes(command, replacementState.getByte());

            return command;
        }

        static Windscreen fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.WINDSCREEN.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Notifications implements Type {
        ...
        public static byte[] notification(String notificationText, NotificationAction[] actions) throws UnsupportedEncodingException, IllegalArgumentException {
            ...
            for (int i = 0; i <actions.length; i++) {
                command = Bytes.concatBytes(command, actions[i].getBytes());
            }
        ...
        public static byte[] notificationAction(int actionIdentifier) {
            return Bytes.concatBytes(NOTIFICATION_ACTION.getIdentifierAndType(), (byte)actionIdentifier);
        }

        static Notifications fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.NOTIFICATIONS.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Messaging implements Type {
        ...
        public static byte[] messageReceived(String handle, String message) throws UnsupportedEncodingException, IllegalArgumentException {
            ...
            command = Bytes.concatBytes(command, handleBytes);
            command = Bytes.concatBytes(command, messageLength);
            command = Bytes.concatBytes(command, messageBytes);

            return command;
        }

        static Messaging fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.MESSAGING.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum VideoHandover implements Type {
        ...
        static VideoHandover fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.VIDEO_HANDOVER.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Browser implements Type {
        ...
        static Browser fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.BROWSER.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Graphics implements Type {
        ...
        static Graphics fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.GRAPHICS.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum TextInput implements Type {
        ...
        public static byte[] textInput(String text) throws UnsupportedEncodingException {
            ...
            command = Bytes.concatBytes(command, (byte) text.length());
        ...
        static TextInput fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.TEXT_INPUT.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum Fueling implements Type {
        ...
        static Fueling fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.FUELING.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum DriverFatigue implements Type {
        ...
        static DriverFatigue fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.DRIVER_FATIGUE.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum TheftAlarm implements Type {
        ...
        static TheftAlarm fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.THEFT_ALARM.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum ParkingTicket implements Type {
        ...
        public static byte[] startParking(String operatorName, int operatorIdentifier,
            ...
            command = Bytes.concatBytes(command, (byte) operatorName.length());
            command = Bytes.concatBytes(command, operatorName.getBytes("UTF-8"));

            byte[] operatorBytes = BigInteger.valueOf(operatorIdentifier).toByteArray();
            command = Bytes.concatBytes(command, (byte) operatorBytes.length);
            command = Bytes.concatBytes(command, operatorBytes);
            ...
            command = Bytes.concatBytes(command, (byte)year);
            command = Bytes.concatBytes(command, (byte)month);
            command = Bytes.concatBytes(command, (byte)day);
            command = Bytes.concatBytes(command, (byte)hour);
            command = Bytes.concatBytes(command, (byte)minute);

            if (endDate == null) {
                byte[] emptyDate = new byte[5];
                command = Bytes.concatBytes(command, emptyDate);
            }
            else {
        ...
        static ParkingTicket fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.PARKING_TICKET.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
    ...
    public enum KeyfobPosition implements Type {
        ...
        static KeyfobPosition fromBytes(byte firstIdentifierByte, byte secondIdentifierByte, byte typeByte) {
            byte[] identifierBytes = Identifier.KEYFOB_POSITION.getIdentifier();
            if (firstIdentifierByte != identifierBytes[0]
                    || secondIdentifierByte != identifierBytes[1]) {
                return null;
            }
